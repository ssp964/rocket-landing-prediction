...
file_name = os.path.join(filepath, 'spacex_launch_geo.csv')
...
if not os.path.exists(filepath):
    ...
    print(f"Directory '{filepath}' has been created.")

# Download the new file
spacex_csv_file = wget.download(url, file_name)
print(f"File downloaded and saved as '{spacex_csv_file}'")
